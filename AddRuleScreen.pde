public class AddRuleScreen extends ControlGroup {
  ...
  protected int field_width = percentX(30);
   ...
   public AddRuleScreen(ControlP5 theControlP5, String theName) {
  ...
  protected AddRuleScreen(ControlP5 theControlP5, ControllerGroup<?> theParent, String theName, int theX, int theY, int theWidth, int theHeight) {
